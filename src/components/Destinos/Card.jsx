    ...
    <>
      {modal && (
        <>
          ...
          <div className="fixed left-1/2  top-1/2 z-50 h-fit max-h-[600px] w-[90%]  max-w-[800px] translate-x-[-50%] translate-y-[-50%] rounded-xl bg-two  xl:h-[600px] xl:w-[600px] xl:max-w-none min-tall-mobile:max-h-[600px] ">
            <button
              onClick={modalFn}
              id="close-modal"
